      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center bg-deep-black overflow-hiddenpt-24 md:pt-32">
        ...
        <div className="container mx-auto px-4 text-center relative z-10 -mt-32">
          <motion.h1
            ...
            className="font-tangerine italic font-bold text-6xl md:text-8xl lg:text-[9rem] text-gold mb-8 leading-tight drop-shadow-lg"
          >
            {t("heroTitle")}
          </motion.h1>
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1 }}
            className="font-tsukimi font-medium text-white/90 text-xl md:text-2xl max-w-2xl mx-auto mt-[45px] mb-12 relative top-[200px] drop-shadow-md"
          >
            {t("heroSubtitle")}
          </motion.p>
        </div>
